...
export type LoginMutation = { __typename?: 'Mutation' } & {
  login: { __typename?: 'LoginResponse' } & Pick<
    LoginResponse,
    'accessToken'
  > & { user: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'image'> }
}
...
export type MeQuery = { __typename?: 'Query' } & {
  me: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'email' | 'image'>>
}
...
export const RegisterDocument = gql`
  mutation Register($email: String!, $password: String!, $image: String!) {
    register(email: $email, password: $password, image: $image)
  }
`
